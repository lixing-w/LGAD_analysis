...
if __name__ == "__main__":
    ...
    train_end_to_end("conditional_autoencoder_model/ivcvscans-2025-10-13-13-07-15/e98_l0.244.pth", reconstruction_weight=2.0, latent_weight=1.0, is_conditional=True)  # More emphasis on reconstruction