...
if __name__ == "__main__":
    ...
    # train_end_to_end("conditional_autoencoder_model/ivcvscans-2025-10-13-14-25-08/e97_l0.269.pth", reconstruction_weight=2.0, latent_weight=1.0, is_conditional=True)  # More emphasis on reconstruction
    train_end_to_end("conditional_autoencoder_model/ivcvscans-2025-10-28-10-30-59/e95_l0.211.pth", reconstruction_weight=2.0, latent_weight=1.0, is_conditional=True)  # More emphasis on reconstruction