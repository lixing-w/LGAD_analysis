...
def criterion(output, target, seq_len, mu, logvar, max_seq_len, device):
    ...
    nonmono_loss = torch.mean(torch.square(relu(-current_diff[:,:,30])))
    
    return curve_loss + kl_loss * 0.5 + mask_loss * 0.5 + nonmono_loss * 0.5
...
if __name__ == '__main__':
    aggregate_train()
    # aggregate_run("autoencoder_model/ivcvscans-2025-08-11-21-34-43/e64_l3.545.pth")