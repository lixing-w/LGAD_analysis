...
def criterion(output, target, seq_len, pred_metrics, target_metrics):
    ...
    curve_loss = mse + mse_1deriv + mse_2deriv * 0.7 + bias_loss * 1.4 #+ smooth_diff * 0.1 + smooth_coeff * 0.025 # 0.025
...
if __name__ == '__main__':
    ...
    aggregate_train()
    # aggregate_run("autoencoder_model/ivcvscans-2025-07-30-05:45:07/e184_l24.232.pth")