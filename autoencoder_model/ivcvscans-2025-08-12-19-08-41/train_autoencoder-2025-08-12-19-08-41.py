...
def criterion(output, target, seq_len, pred_metrics, target_metrics, max_seq_len, device):
    ...
    curve_loss = mse + mse_1deriv + mse_2deriv + l1_loss * 1.7 + bias_loss * 2  # + smooth_diff * 0.1 + smooth_coeff * 0.025 # 0.025
...
if __name__ == '__main__':
    ...
    aggregate_train()
    # aggregate_run("autoencoder_model/ivcvscans-2025-08-12-18-29-41/e99_l16.700.pth")
