...
def criterion(output, target, seq_len, pred_metrics, target_metrics, max_seq_len, device):
    ...
    metrics_loss = temp_loss+date_sensor_num_loss+humi_loss+ramp_type_loss+dura_loss+bdv_loss*2
...
if __name__ == '__main__':
    ...
    aggregate_train()
    # aggregate_run("autoencoder_model/ivcvscans-2025-07-30-06:42:46/e102_l13.814.pth")