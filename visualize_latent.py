...
def plot_latent(model_path: str):
    ...
    dataset = AggregateIVDatasetForAutoEncoder(DATABASE_DIR, mode="eval")
...
if __name__ == '__main__':
    plot_latent("autoencoder_model/ivcvscans-2025-07-28-20:20:03/e275_l0.010.pth")